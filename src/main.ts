...
const { canvas, ctx } = getCanvasContext("game");
...
function createDemoPlayer(id: string, name: string) {
...
const gameState = new GameState(board, [
  createDemoPlayer("player-1", "Jogador 1"),
  createDemoPlayer("player-2", "Jogador 2"),
]);
